...
- One physical line, exact format:
  `- YYYY-MM-DD <imperative fix or invariant> [ctx: taste-skill/<project-or-->]`
...
`python3 ~/.claude/lib/self-improving-loop/sil/cli.py lessons-append \
  --file "<resolved-path>" --date "YYYY-MM-DD" --window "run" --note "<imperative rule>" --tweak "taste-skill/<project>"`

---

## Recommended next step

Next: `/critique` — generated bias-corrected UI benefits from an independent UX/slop review before ship.
